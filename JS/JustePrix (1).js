...
function res(){                                                         // Fonction pour le comportement du bouton "Voir les scores"
    ...
    if(guessNbr<guessNbr2){                             // Si notre nombre d'essaies est inferieur a celui de l'ordinateur
        ...
        document.getElementById("photowin").style.display="flex";
    }
    else if(guessNbr>guessNbr2 && guessNbr< 1000){                             // Si notre nombre d'essaies est superieur a celui de l'ordinateur
        document.getElementById("answer").innerText = lose; // Affichage de la variable qui contient le message de fin en cas de defaite
        document.getElementById("photolose").style.display="flex";
    }
        ...
        document.getElementById("photoequal").style.display="flex";
    }
    else if(guessNbr>1000 && guessNbr>guessNbr2){
        document.getElementById("answer").innerText = lose; 
        document.getElementById("photocheater").style.display="flex";
    }
